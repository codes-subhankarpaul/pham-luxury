...
if ( ! class_exists( 'phamluxury_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since phamluxury 1.0
	 */
	class phamluxury_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'phamluxury' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'phamluxury' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'phamluxury' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'phamluxury' ),
						'full'    => esc_html__( 'Full text', 'phamluxury' ),
					),
				)
			);
			...
			require_once get_theme_file_path( 'classes/class-phamluxury-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'phamluxury_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new phamluxury_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'phamluxury' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
